...
export default function Dashboard() {
  ...
  const load = async () => {
    ...
    try {
      ...
      try {
        tProf = await api.myTrainerProfile();
      } catch {}
      try {
        cProf = await api.myClientProfile();
      } catch {}
      setTrainerProfile(tProf);
      setClientProfile(cProf);

      try {
        setTBookings(await api.trainerBookings());
      } catch {}
      try {
        setCBookings(await api.clientBookings());
      } catch {}
    } catch (e: any) {
            ...
            {loading ? (
                ...
                <div>
                  <Card>
                    ...
                    <CardContent className="text-sm grid gap-3">
                      ...
                      <BookingsChart
                        data={Object.values(
                          cBookings.reduce((acc: any, b: any) => {
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Tell trainers about your goals.
                  </CardDescription>
                </CardHeader>
                <CardContent>
            ...
            {loading ? (
                ...
                <div>
                  <Card>
                    ...
                    <CardContent className="text-sm grid gap-3">
                      ...
                      <BookingsChart
                        data={Object.values(
                          tBookings.reduce((acc: any, b: any) => {
                            const d = b.session_date || "";
                            acc[d] = acc[d] || { date: d, count: 0 };
                            acc[d].count += 1;
                            return acc;
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Let clients discover your expertise.
                  </CardDescription>
                </CardHeader>
                <CardContent>
